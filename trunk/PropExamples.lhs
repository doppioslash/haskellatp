...
> halfAdder :: Formula Prop -> Formula Prop -> Formula Prop 
...
> carry :: Formula Prop -> Formula Prop -> Formula Prop -> Formula Prop
> carry x y z = (x /\ y) \/ ((x \/ y) /\ z)

'sum' is in the Haskell Prelude

> csum :: Formula Prop -> Formula Prop -> Formula Prop -> Formula Prop
> csum x y z = halfsum (halfsum x y) z

> fa :: Formula Prop -> Formula Prop -> Formula Prop -> Formula Prop 
>    -> Formula Prop -> Formula Prop
...
> type Wire = Int -> Formula Prop

> conjoin :: Wire -> [Int] -> Formula Prop
...
> mkIndex :: Var -> Int -> Formula Prop
> mkIndex x i = Atom(P (x ++ "_" ++ show i))

> mkIndex2 :: Var -> Int -> Int -> Formula Prop
> mkIndex2 x i j = Atom(P (x ++ "_" ++ show i ++ "_" ++ show j))
...
> mkAdderTest :: Int -> Int -> Formula Prop
> mkAdderTest n k =
...
> rippleshift :: Wire -> Wire -> Wire -> Formula Prop -> Wire -> Wire
...
> type Wire2 = Int -> Int -> Formula Prop
