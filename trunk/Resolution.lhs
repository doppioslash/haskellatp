...
> rename :: String -> Clause Fol -> Clause Fol
> rename pfx cls =
...
> resolvents :: Clause Fol -> Clause Fol -> Formula Fol -> [Clause Fol] -> [Clause Fol]
...
> resolveClauses :: Clause Fol -> Clause Fol -> [Clause Fol]
...
> basicResloop :: ([Clause Fol], [Clause Fol]) -> IO ()
...
> pureBasicResolution :: Formula Fol -> IO ()
...
> basicResolution :: Formula Fol -> IO ()
> basicResolution fm = 
...
> matchLiterals :: Env -> (Formula Fol, Formula Fol) -> Maybe Env
...
> subsumesClause :: Clause Fol -> Clause Fol -> Bool
...
> replace :: Clause Fol -> Clauses Fol -> Clauses Fol
> replace cl [] = [cl]
...
> incorporate :: Clause Fol -> Clause Fol -> Clauses Fol -> Clauses Fol
...
> resloop :: ([Clause Fol], [Clause Fol]) -> IO ()
...
> presolveClauses :: Clause Fol -> Clause Fol -> [Clause Fol]
...
> positiveResloop :: ([Clause Fol], [Clause Fol]) -> IO ()
...
> purePositiveResolution :: Formula Fol -> IO ()
...
> positiveResolution :: Formula Fol -> IO ()
