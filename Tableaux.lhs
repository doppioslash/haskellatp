...
> unifyLiterals :: Env -> (Formula Fol, Formula Fol) -> Maybe Env
...
> unifyComplements :: Env -> (Formula Fol, Formula Fol) -> Maybe Env
...
> unifyRefute :: [[Formula Fol]] -> Env -> Maybe Env
...
> prawitzLoop :: [[Formula Fol]] -> Vars -> [[Formula Fol]] 
>             -> Int -> Maybe (Env, Int)
...
> tableau :: ([Formula Fol], [Formula Fol], Int) 
